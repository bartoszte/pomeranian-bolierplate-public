import { PromisesMethodsTraning } from './PromisesMethodsTraining';
...
export const PromisesMethods = () => {
  ...
  // Promise.race([new Promise(), new Promise()]) = [tablica promisów]
  ...
  return (
    <div>
      <h2>Promises Methods</h2>
      <div>cos</div>
      <PromisesMethodsTraning />
    </div>
  );
};
